...
class Config(object):
    ...
    #APP_VER     = '8.4.1'
    CARRIER     = '51089, 1-0'
    SYSTEM_NAME = 'Angrust_PC'
    #SYSTEM_VER  = '8.22.17'
    IP_ADDR     = '1.1.1.1'
    EMAIL_REGEX = re.compile(r"[^@]+@[^@]+\.[^@]+")

    def __init__(self):
        self.APP_NAME = 'CHROMEOS	\t8.2.2\tANGRUST-ANNUNG11.2.5'#'%s\t%s\t%s\t%s' % (self.APP_TYPE, self.APP_VER, self.SYSTEM_NAME, self.SYSTEM_VER)
        self.USER_AGENT = 'Angrust/8.2.2'#'Line/%s' % self.APP_VER
